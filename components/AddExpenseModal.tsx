...
const AddExpenseModal: React.FC<AddExpenseModalProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-white rounded-t-3xl sm:rounded-3xl p-6 w-full max-w-md max-h-[90vh] overflow-y-auto no-scrollbar">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="0"
                className={`w-full bg-slate-50 border py-3.5 pl-11 pr-4 rounded-2xl outline-none focus:ring-2 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-semibold ${errors.amount ? 'border-rose-300' : 'border-slate-100'}`}
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full bg-slate-50 border py-3.5 pl-11 pr-4 rounded-2xl outline-none focus:ring-2 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-semibold ${errors.description ? 'border-rose-300' : 'border-slate-100'}`}
              />
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full bg-slate-50 border py-3.5 pl-11 pr-4 rounded-2xl outline-none focus:ring-2 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-semibold text-sm ${errors.date ? 'border-rose-300' : 'border-slate-100'}`}
              />
            </div>
          ...
          {formData.amount > 0 && formData.participants.length > 0 && (
            <div className="bg-indigo-50 rounded-2xl p-4 text-center">
              <p className="text-xs text-indigo-400 font-bold uppercase tracking-widest">Per Person</p>
